...
<div class="pure-controls">
        ...
        <div id="data_monitoring_data" style="display: none;" class="erm">
                <div class="pure-controls">
                        ...
                        <input type="text" name="queueName" id="queueName" validate="validateStr" caption="Queue Name" placeholder="Rabbit MQ Queue name" style="width: 400px;">
                        <span class="error" id="queueName_error"></span>
                </div>
                ...
                <label>Operation : Create a Queue, add n keys & delete the queue</label>
                <div id="resp_time" style="display: none;" class="erm">
                        <label for="responseTime">Operation Time</label>
